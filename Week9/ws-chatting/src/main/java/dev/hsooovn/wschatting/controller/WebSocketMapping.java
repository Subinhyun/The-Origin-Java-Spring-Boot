package dev.hsooovn.wschatting.controller;

import dev.hsooovn.wschatting.model.ChatMessage;
...
public class WebSocketMapping {
    ...
    public void sendChat(ChatMessage chatMessage){
        ...
        simpMessagingTemplate.convertAndSend(
                String.format("/receive-endpoint/%s", chatMessage.getRoomId()), chatMessage
        );
    }
}
