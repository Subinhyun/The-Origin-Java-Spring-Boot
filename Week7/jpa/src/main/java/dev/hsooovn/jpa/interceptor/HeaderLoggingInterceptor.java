package dev.hsooovn.jpa.interceptor;
...
public class HeaderLoggingInterceptor implements HandlerInterceptor {
    ...
    public void afterCompletion(HttpServletRequest request, HttpServletResponse response, Object handler, Exception ex) throws Exception {
        HandlerMethod handlerMethod = (HandlerMethod) handler;
        logger.info("completed start processing of {}", handlerMethod.getMethod().getName());
        if(ex != null) logger.info("Exception occurred while processing", ex);
    }
}
